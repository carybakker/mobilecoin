...
// FIXME: Remove when prost-generated for `derive(Oneof)` has the necessary
...
pub enum VersionedMaskedAmount {
    /// A v1 masked amount.
...
impl VersionedMaskedAmount {
    ...
    pub fn get_masked_token_id(&self) -> &[u8] {
        match self {
